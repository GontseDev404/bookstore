...
By sharing this narrative with readers, I invite them to appreciate the power of storytelling in preserving memories, passing down wisdom, and connecting generations through shared experiences and imaginative retellings.`,
  ...
  "fearless": {
    ...
    formats: [
      ...
      { id: "paperback", name: "Paperback", price: 16.99 },
    ...
    editorialReviews: [
      "A powerful story of overcoming fear and finding strength within.",
      "Roberts delivers a compelling narrative that resonates with readers of all ages.",
    ],
    customerReviews: [
      {
        id: "review1",
        ...
        content: "This book changed my perspective on facing challenges.",
      },
    ],
    relatedBooks: [
      {
  ...
  "great-big-beautiful-life": {
    ...
    rating: 4.5,
    reviewCount: 33,
    description: "A heartwarming story about finding beauty in everyday moments.",
    formats: [
      { id: "hardcover", name: "Hardcover", price: 18.99, originalPrice: 23.99 },
      { id: "paperback", name: "Paperback", price: 14.99 },
    ...
    editorialReviews: [
      "Henry's prose is both lyrical and accessible, creating an immersive reading experience.",
      "A celebration of life's simple pleasures and profound moments.",
    ],
    customerReviews: [
      {
        id: "review1",
        ...
        content: "A lovely book that reminds us to appreciate the little things.",
      },
    ],
    relatedBooks: [
      {
  ...
  "the-tenant": {
    ...
    editorialReviews: [
      "McFadden masterfully builds tension and suspense throughout this gripping thriller.",
      "A page-turner that will keep readers on the edge of their seats.",
    ],
    customerReviews: [
      {
        id: "review1",
        ...
        content: "Couldn't put this down! The twists and turns kept me guessing.",
      },
    ],
    relatedBooks: [
      {
  ...
  "remarkably-bright-creatures": {
    ...
    rating: 4.6,
    reviewCount: 35,
    description: "A touching story about unlikely friendships and the power of connection.",
    formats: [
      { id: "hardcover", name: "Hardcover", price: 20.99, originalPrice: 25.99 },
      { id: "paperback", name: "Paperback", price: 15.99 },
    ...
    editorialReviews: [
      "Van Pelt's debut novel is a testament to the power of storytelling and human connection.",
      "A beautifully crafted narrative that explores themes of loneliness, friendship, and redemption.",
    ],
    customerReviews: [
      {
        id: "review1",
        author: "LiteraryReader",
        date: "2024-01-25",
        rating: 4,
        title: "Heartwarming and Thoughtful",
        content: "A beautiful story about finding connection in unexpected places.",
      },
    ],
    relatedBooks: [
      {
  ...
  "emperor-of-gladness": {
    ...
    rating: 4.9,
    reviewCount: 42,
    description: "A poetic exploration of identity, memory, and the search for meaning.",
    formats: [
      { id: "hardcover", name: "Hardcover", price: 24.99, originalPrice: 29.99 },
      { id: "paperback", name: "Paperback", price: 18.99 },
    ...
    editorialReviews: [
      "Vuong's lyrical prose and profound insights create an unforgettable reading experience.",
      "A masterful work that challenges and enlightens readers with every page.",
    ],
    customerReviews: [
      {
        id: "review1",
        ...
        date: "2024-02-01",
        rating: 5,
        title: "Profound and Beautiful",
        content: "Vuong's words have the power to transform how we see the world.",
      },
    ],
    relatedBooks: [
      {
  ...
  "marble-hall-murders": {
    ...
    rating: 4.8,
    reviewCount: 39,
    description: "A classic whodunit set in the elegant halls of British aristocracy.",
    formats: [
      { id: "hardcover", name: "Hardcover", price: 23.99, originalPrice: 28.99 },
      { id: "paperback", name: "Paperback", price: 17.99 },
    ...
    editorialReviews: [
      "Horowitz delivers another masterful mystery with intricate plotting and memorable characters.",
      "A sophisticated detective story that pays homage to the golden age of crime fiction.",
    ],
    customerReviews: [
      {
        id: "review1",
        ...
        date: "2024-02-05",
        rating: 4,
        title: "Classic British Mystery",
        content: "Perfect for fans of Agatha Christie and classic detective stories.",
      },
    ],
    relatedBooks: [
      {
