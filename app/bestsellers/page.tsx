  ...
  return (
    <AppShell>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Staff Favorites</h1>
          <p className="text-gray-600">Handpicked recommendations from our book-loving staff</p>
        </div>
